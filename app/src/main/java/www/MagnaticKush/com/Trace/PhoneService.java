...
public class PhoneService extends Service {
    ...
    private final static String TAG = "PhoneService";
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
          ...
          //  stopSelf(msg.arg1);  //notification will go away as well. //earlier working
            telephonyManager.listen(phoneListener, PhoneStateListener.LISTEN_CALL_STATE);
        }
    }
    ...
    void toast(final CharSequence text) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(PhoneService.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
       // Toast.makeText(this, "service starting", Toast.LENGTH_SHORT).show();
        ...
        if (intent != null) {
            ...
            Toast.makeText(PhoneService.this, "The Intent to start is null?!", Toast.LENGTH_SHORT).show();
        }
    ...
    public Notification getNotification(String message) {
        ...
        return new NotificationCompat.Builder(getApplicationContext(), CallLogMailer.id1)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setOngoing(true)  //persistent notification!
                .setChannelId(CallLogMailer.id1)
